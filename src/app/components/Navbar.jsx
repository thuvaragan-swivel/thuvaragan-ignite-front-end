    ...
    <Navbar bg="primary" variant="dark" expand="lg" className="mb-3 custom-navbar" >
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="ml-auto">
          <NavDropdown title={<><FaList className="me-2" />View</>} id="basic-nav-dropdown">
            <NavDropdown.Item onClick={() => dispatch(setView('table'))} active={view === 'table'}>
              <FaTable className="me-2" />
              Table
            </NavDropdown.Item>
            <NavDropdown.Item onClick={() => dispatch(setView('grid'))} active={view === 'grid'}>
              <FaTh className="me-2" />
              Grid
            </NavDropdown.Item>
          </NavDropdown>
